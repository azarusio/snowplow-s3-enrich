...
def test():
   testString = ''
   params = base64.b64decode(testString + '===')
   s = params.decode("utf-8")
   print(s)

   # base64_message = ''
...
def test2():
        datvalues = ""
        urispltnodes = ['e=ue', 'ue_pr=%257B%2522schema%2522%253A%2522iglu%253Acom.snowplowanalytics.snowplow%252Funstruct_event%252Fjsonschema%252F1-0-0%2522%252C%2522data%2522%253A%257B%2522schema%2522%253A%2522iglu%253A%2520io.azarus%252Fachievement_gui_interaction%252Fjsonschema%252F1-0-0%2522%252C%2522data%2522%253A%257B%2522azarus_id%2522%253A%25225b8ed63aabba2c00110d736b%2522%252C%2522gui_element_id%2522%253A%2522test111%2522%252C%2522game_id%2522%253A%2522R6s%2522%252C%2522achievement_id%2522%253A%2522test222%2522%252C%2522achievement_specific_id%2522%253A%2522test333%2522%252C%2522achievement_meta_field%2522%253A%257B%2522level%2522%253A%252212%2522%252C%2522operator%2522%253A%2522Test%2520Operator%2522%252C%2522gun_name%2522%253A%2522Test%2520Gun%2522%252C%2522map_name%2522%253A%2522Test%2520Map%2522%252C%2522window_size%2522%253A1234%257D%252C%2522funnel_id%2522%253A%2522test444%2522%257D%257D%257D', 'p=srv', 'tv=node-0.3.0', 'aid=aza-back-end', 'eid=a4b4e4b7-25dd-4e2c-aef8-99e44ff32d49', 'dtm=1581636424369']
        spvalues = {'app_id': '-','platform': '-','collector_tstamp': 1581420409961,'dvce_created_tstamp': '-','event': '-','event_id': '-','txn_id': '-','name_tracker': '-','v_tracker': '-','user_id': '-','user_ipaddress': '0.0.0.0','user_fingerprint': '-','domain_userid': '-','domain_sessionidx': '-','network_userid': '-','geo_country': 'UA','geo_city': 'Mykolaiv','geo_zipcode': '54000','geo_latitude': 12345678,'geo_longitude': 12345678,'geo_region_name': 'Mykolaiv region','page_url': '-','page_title': '-','page_referrer': '-','refr_urlscheme': 'test','refr_urlhost': 'test','refr_urlpath': 'test','refr_urlquery': 'test','se_category': '-','se_action': '-','se_label': '-','se_property': '-','se_value': '-','unstruct_event': '-','tr_orderid': '-','tr_affiliation': '-','tr_total': '-','tr_tax': '-','tr_shipping': '-','tr_city': '-','tr_state': '-','tr_country': '-','ti_orderid': '-','ti_sku': '-','ti_name': '-','ti_category': '-','ti_price': '-','ti_quantity': '-','pp_xoffset_min': '-','pp_xoffset_max': '-','pp_yoffset_min': '-','pp_yoffset_max': '-','useragent': 'test','br_name': 'test','br_family': 'test','br_version': 'test','br_lang': '-','br_features_pdf': '-','br_features_flash': '-','br_features_java': '-','br_features_director': '-','br_features_quicktime': '-','br_features_realplayer': '-','br_features_windowsmedia': '-','br_features_gears': '-','br_features_silverlight': '-','br_cookies': '-','br_colordepth': '-','br_viewwidth': '-','br_viewheight': '-','os_family': 'test','os_timezone': '-','dvce_type': 'test','dvce_ismobile': 'false','dvce_screenwidth': '-','dvce_screenheight': '-','doc_charset': '-','doc_width': '-','doc_height': '-','tr_currency': '-','ti_currency': '-','geo_timezone': 'test','dvce_sent_tstamp': '-','domain_sessionid': '-','event_vendor': '-'}
