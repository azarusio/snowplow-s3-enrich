...
GRANT CONNECT ON DATABASE snowplow TO data_analyst;
GRANT USAGE ON SCHEMA atomic TO data_analyst;
GRANT SELECT ON ALL TABLES IN SCHEMA atomic TO data_analyst;
